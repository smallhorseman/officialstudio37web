...
export function EnhancedCrmSection({ leads, updateLeadStatus }) {
  ...
  const addNote = async () => {
    ...
    try {
      ...
      if (!error) {
        setNewNote({ note: '', note_type: 'manual', priority: 'normal' });
  ...
  if (!leads || leads.length === 0) {
    return <div className="text-[#F3E3C3]/70 py-8 text-center">No leads found.</div>;
  }
        ...
        <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50 p-4">
          <div className="bg-[#232323] rounded-lg shadow-lg max-w-4xl w-full max-h-[90vh] overflow-hidden">
            <div className="flex justify-between items-center p-6 border-b border-white/10">
              ...
              <button onClick={() => setShowLeadDetails(false)} className="text-white text-xl hover:text-red-400">×</button>
            </div>
            ...
            <div className="flex h-[calc(90vh-80px)]">
                    ...
                    <div className="space-y-2">
                      {selectedLead.phone && (
                        <button
                          ...
                          className="w-full bg-green-500 text-white rounded-md py-2 px-3 text-sm font-semibold flex items-center justify-center gap-2 hover:bg-green-600"
                        >
                          <PhoneIcon />
                          Call
                        </button>
                      ...
                      <button
                        ...
                        className="w-full bg-red-500 text-white rounded-md py-2 px-3 text-sm font-semibold flex items-center justify-center gap-2 hover:bg-red-600"
                      >
                        <MailIcon />
                        Email
                      </button>
              ...
              <div className="flex-1 flex flex-col">
                ...
                <div className="flex-1 overflow-y-auto p-6">
                  ...
                  {!loading && leadNotes.length === 0 && (
                    <div className="text-[#F3E3C3]/70 py-4 text-center text-sm">No notes found.</div>
                  )}
