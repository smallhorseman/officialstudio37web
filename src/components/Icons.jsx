...
export const PhoneIcon = Phone; // Alias for compatibility
export const MailIcon = Mail; // Alias for compatibility
...
export const MapPinIcon = MapPin; // Alias for compatibility
